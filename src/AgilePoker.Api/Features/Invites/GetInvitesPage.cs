...
namespace AgilePoker.Api.Features
{
    public class GetInvitesPage
    {
        ...
        public class Response: ResponseBase
        {
            ...
            public List<InviteDto> Entities { get; set; }
        }
        ...
        public class Handler: IRequestHandler<Request, Response>
        {
            ...
            {
                var query = from invite in _context.Invites
                    select invite;
                
                var length = await _context.Invites.CountAsync();
                
                var invites = await query.Page(request.Index, request.PageSize)
